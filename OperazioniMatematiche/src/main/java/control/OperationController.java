...
public class OperationController {
	...
	public Double executeOperation() throws CalcolatriceException {
		if (this.currentOperation == null)
		...
		Double result = this.currentOperation.calcola(this.inputA, this.inputB);
		String equation = this.currentOperation.toString();
		this.operationLog.add(equation);
		this.output.add(equation);
		return result;
	}
