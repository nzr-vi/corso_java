...
@WebServlet("/relation/list")
public class ListServlet extends RelationServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			request.setAttribute("list", this.ctrl.getAll());
			request.setAttribute("titles", new String[] { "ID Libro", "Libro", "ID Autore", "Cognome" });
