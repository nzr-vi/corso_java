...
@WebServlet("/book/element")
public class ElementServlet extends BookServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("item_data", this.ctrl.getDataMap(this.ctrl.getLibro(id)));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int rowUpdated = this.ctrl.updateLibro(id, request.getParameter("titolo"),
