...
public class SelectionMenu {
	...
	public SelectionMenu() {
		...
		this.exercizes.add(new Es5(this.inputScan));
		this.exercizes.add(new Es6(this.inputScan));
		this.exercizes.add(new Es7(this.inputScan));
		this.exercizes.add(new Es8(this.inputScan));
